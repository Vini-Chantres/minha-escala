        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_users_role", "\"Role\" IN ('Owner', 'Member')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sector = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_entries_type", "\"Type\" IN ('folga', 'trabalho')");
                    table.ForeignKey(
                        name: "FK_schedule_entries_users_UserId_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_schedule_entries_TenantId_UserId",
                table: "schedule_entries",
                columns: new[] { "TenantId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_schedule_entries_UserId_Date",
                table: "schedule_entries",
                columns: new[] { "UserId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_schedule_entries_UserId_TenantId",
                table: "schedule_entries",
